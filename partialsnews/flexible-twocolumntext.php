<section class="home-text-img anitrigger <?php the_sub_field('padding'); ?> <?php the_sub_field('padding_bottom'); ?> <?php the_sub_field('hide_from_mobile'); ?> <?php the_sub_field('button_style'); ?>" style="background-color:<?php the_sub_field('background_colour'); ?>;">
