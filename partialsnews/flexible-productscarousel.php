    ...
    <div class="container textcenter simplefade simplefade-2">
        <?php $row_count = count(get_sub_field('product_item')); ?>
            <?php if( have_rows('product_item')): // check for repeater fields ?>
                <div class="home-products-slider products-alt-journal products-nos-<?php echo $row_count; ?> rowflex">
                <div class="slides" style="display: flex;">
            <?php while ( have_rows('product_item')) : the_row(); // loop through the repeater fields ?>
<div class="product hitbox <?php if ( get_sub_field('hide_price') ) { ?>product-hide-price<?php } else { ?><?php } ?> <?php if ( get_sub_field('hide_button') ) { ?>product-hide-button<?php } else { ?><?php } ?>" style="width:454px;">
            <?php // set up post object
                ...
                <div class="textpadding_sm_"><a href="<?php the_permalink(); ?>" class="forcedimg-hold" style="height: 0; padding-bottom: 100%;"><img loading="lazy" data-src="<?php the_post_thumbnail_url('large'); ?>" src="data:image/gif;base64,R0lGODlhAQABAAAAACH5BAEKAAEALAAAAAABAAEAAAICTAEAOw==" alt="C&S popular product" class="forcedimg animate lazy-hidden lazyload respondimg" /><img src="https://www.czechandspeake.com/fragrance/wp-content/themes/storefront-child-C%26S/images/square.png" alt="C&S" /></a>
                    <p>
                        <?php the_title(); ?>
                    </p>
                    <p class="prod-price">
