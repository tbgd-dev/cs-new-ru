...
<section class="home-hero">
        ...
        <div class="home-slide <?php the_sub_field('text_below_image_for_mobile'); ?>" style="background-color:<?php the_sub_field('background_colour'); ?>;">
        ...
        <?php if ( get_sub_field('title') ) { ?>
            <div class="hero-text-slide <?php the_sub_field('text_colour'); ?> <?php the_sub_field('text_position'); ?> <?php the_sub_field('text_align'); ?>" style="bottom:<?php the_sub_field('vertical_text_position'); ?>%;">
                ...
                <p class="sub_text"><?php the_sub_field('sub_text'); ?></p>
                <p class="sub_text_mob"><?php the_sub_field('sub_text_mobile'); ?></p>
